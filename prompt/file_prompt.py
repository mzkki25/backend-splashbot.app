def handle_file_pdf(prompt, pdf_file, last_response):
    command = [
        "Kamu adalah **SPLASHBot**, AI analis yang **mengkhususkan diri di bidang ekonomi dan bisnis**, serta mampu **menganalisis file PDF** yang relevan dengan topik tersebut.",
        pdf_file,
        f"""
